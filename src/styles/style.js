const styles = {
  boxWidth: "xl:max-w-[1300px] w-full sm:px-8 px-8",
  ...
  flexLeft: "flex justify-left items-center",
...
export const layout = {
  ...
  sectionImg: `printer-container flex-1 flex ${styles.flexCenter} md:ml-10 md:mt-5 mt-5 mb-5 relative`,
